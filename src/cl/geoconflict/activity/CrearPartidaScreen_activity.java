		...
		lista.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> adapter, View view,
				...
				if(firstSelected == null){
					...
					//Log.d("debug","valor a consultar: " + (adapter.getCount() - position - 1));
					firstSelected = adapter.getChildAt(adapter.getCount() - position - 1);
					...
					if(teamFirstSelected.equals("red"))
						firstSelected.setBackgroundResource(R.drawable.hugh_layer_black);
					else
						firstSelected.setBackgroundResource(R.drawable.hugh_layer_red);
				}else{
